...
describe("Dexz", function () {
  ...
  it("00. Test 00", async function () {
    ...
    const actionsB1 = [
      { action: Action.FillAnyAndAddOrder, buySell: BuySell.Sell, base: data.token0.address, quote: data.weth.address, price: ethers.utils.parseUnits(price2, 12).toString(), targetPrice: ethers.utils.parseUnits(targetPrice1, 12).toString(), expiry: expiry, tokens: baseTokensB1.toString() },
    ...
    // const baseTokensB2 = ethers.utils.parseUnits("10", data.decimals0);
    // const actionsB2 = [
    ...
    //   { action: Action.FillAnyAndAddOrder, buySell: BuySell.Sell, base: data.token0.address, quote: data.weth.address, price: ethers.utils.parseUnits(price3, 12).toString(), targetPrice: ethers.utils.parseUnits(targetPrice1, 12).toString(), expiry: expiry, tokens: baseTokensB2.toString() },
    // ];
