...
function addTokenContractAddressAndAbi(i, address, abi) {
  ...
  // console.log("addTokenContractAddressAndAbi - i: " + i);
  // console.log("addTokenContractAddressAndAbi - address: " + address);
  // console.log("addTokenContractAddressAndAbi - abi: " + JSON.stringify(abi));
